...
/// @details Files are written to a temp directory determined by
...
/// @brief Dump each tensor in `debugTensorNames` to an npy file if it is
/// found in one of the tensor maps.
/// @details Files are written to a temp directory determined by
/// `std::filesystem::temp_directory_path`,
/// the exact paths are logged at INFO level.
