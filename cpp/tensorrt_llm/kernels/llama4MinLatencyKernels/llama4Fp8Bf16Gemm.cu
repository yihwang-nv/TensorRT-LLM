...
DEFINE_GET_PER_BLOCK_ATTN_SCALING_FUNC_PTR(
    /*HIDDEN_IN=*/5120, /*ALIGNED=*/true, /*POS_IDS_INT64=*/false);
DEFINE_GET_PER_BLOCK_ATTN_SCALING_FUNC_PTR(
    /*HIDDEN_IN=*/5120, /*ALIGNED=*/true, /*POS_IDS_INT64=*/true);
    ...
    int hidden_in, int hidden_out, cudaStream_t stream)
{
    ...
    if (num_tokens == 1)
    {
        // When num_tokens == 1, the best tiling size is tile_token == 1 and
        // tile_out == 1.
    ...
    {
        // When num_tokens == 2, the best tiling size is tile_token == 2 and
        // tile_out == 1.
    ...
    {
        // When num_tokens == 3, the best tiling size is tile_token == 1 and
        // tile_out == 4.
    ...
    {
        // When num_tokens == 4, the best tiling size is tile_token == 2 and
        // tile_out == 2.
    ...
    {
        // When num_tokens == 5, the best tiling size is tile_token == 1 and
        // tile_out == 4.
        dim3 const grid_size = dim3(div_up(hidden_out, 4), div_up(num_tokens, 1), 1);
        void* kernel_func = get_per_block_func_ptr_aligned_true_5120_(1, 4);
        launch_kernel_pdl(dim3(grid_size), dim3(BLOCK_SIZE), stream, kernel_func, args, 7);
    ...
    {
        // When num_tokens == 6, the best tiling size is tile_token == 3 and
        // tile_out == 4.
    ...
    {
        // When num_tokens == 7, the best tiling size is tile_token == 1 and
        // tile_out == 4.
        dim3 const grid_size = dim3(div_up(hidden_out, 4), div_up(num_tokens, 1), 1);
        void* kernel_func = get_per_block_func_ptr_aligned_true_5120_(1, 4);
        launch_kernel_pdl(dim3(grid_size), dim3(BLOCK_SIZE), stream, kernel_func, args, 7);
    ...
    {
        // When num_tokens == 8, the best tiling size is tile_token == 2 and
        // tile_out == 4.
    ...
    int hidden_out, int q_hidden_out, cudaStream_t stream)
{
    ...
    {
        // When num_tokens == 6, the best tiling size is tile_token == 2 and
        // tile_out == 4.
        dim3 const grid_size = dim3(div_up(hidden_out, 4), div_up(num_tokens, 2), 1);
